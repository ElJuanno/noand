...
<style>
    ...
    .dashboard h2{font-weight:700;color:#388E3C}
    .card-custom{
        border-radius:20px;background:#fff;
        box-shadow:0 4px 14px rgba(56,142,60,.07);
        transition:transform .2s, box-shadow .2s; min-height:190px
    }
    .card-custom:hover{transform:translateY(-5px) scale(1.02);box-shadow:0 8px 20px rgba(56,142,60,.13)}
    .card-body i{font-size:2.2rem;color:#388E3C;margin-bottom:10px}
    .card-title{color:#2e7d32;font-weight:600}
    .consejo{font-size:1.08rem;color:#616161;margin-top:8px}
</style>
        ...
        <div class="col-12">
            <div class="card card-custom h-100 p-2">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="{{ route('planes.alimenticio') }}" class="btn btn-outline-success">
        ...
        <div class="col-12 col-md-4">
            <div class="card card-custom h-100 p-2">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="{{ route('plan.alimenticio') }}" class="btn btn-outline-success">
                        Ver recetas
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-4">
            <div class="card card-custom h-100 p-2">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="{{ route('alergias.index') }}" class="btn btn-outline-success btn-sm mt-auto">
                        Gestionar alergias
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md">
            <div class="card card-custom h-100 p-2">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <!-- FIX: antes route('comida.create') -->
                    <a href="{{ route('seguimiento.index') }}" class="btn btn-outline-success btn-sm mt-auto">
                        Registrar Comida
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md">
            <div class="card card-custom h-100 p-2">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    <a href="{{ route('salud.overview') }}" class="btn btn-outline-success btn-sm mt-auto">Ver salud</a>
                </div>
            </div>
        </div>
